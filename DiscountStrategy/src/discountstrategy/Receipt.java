...
public class Receipt {
    ...
    public Receipt(String customerId, ReceiptDataAccessStrategy dataBase, MyUtilities myUtilities) {
        if (!customerId.isEmpty()) {
            customer = findCustomer(customerId, dataBase);
        } else {
            customer = new Customer("Not Provided", "Not Provided");
        }
        setTodaysDateAndCurrentTime(myUtilities.getTodaysDateAndCurrentTime());
